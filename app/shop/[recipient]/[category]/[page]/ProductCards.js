    ...
    <div className="w-full h-full">
      {productList.length === 0 ? (
        checklist.prices || checklist.ratings || checklist.reviews ? (
          ...
          <div className="w-full h-full flex justify-center items-center my-24">
            <div role="status w-[25%] h-[25%]">
              <svg
                className="inline mr-2 w-full h-full text-gray-200 animate-spin dark:text-gray-600 fill-cblue-300"
                viewBox="0 0 100 101"
                fill="none"
